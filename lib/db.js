...
CREATE TABLE IF NOT EXISTS capas (
  ...
  corrective_completion_date TEXT,
  corrective_completed_by    TEXT,
  preventive_action          TEXT,
  preventive_due_date        TEXT,
  preventive_completion_date TEXT,
  preventive_completed_by    TEXT,
...
async function initDb() {
  ...
  try {
    ...
    // CREATE TABLE IF NOT EXISTS only helps brand-new databases; existing
    // deployments need these columns added explicitly.
    await client.query(`
      ALTER TABLE qms.capas
        ADD COLUMN IF NOT EXISTS corrective_due_date        TEXT,
        ADD COLUMN IF NOT EXISTS corrective_completion_date TEXT,
        ADD COLUMN IF NOT EXISTS corrective_completed_by    TEXT,
        ADD COLUMN IF NOT EXISTS preventive_action          TEXT,
        ADD COLUMN IF NOT EXISTS preventive_due_date        TEXT,
        ADD COLUMN IF NOT EXISTS preventive_completion_date TEXT,
        ADD COLUMN IF NOT EXISTS preventive_completed_by    TEXT,
